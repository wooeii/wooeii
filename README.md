...
### 🚀 Core Projects  
* **[SpringBoot-Music-Archive](https://github.com/wooeii/SpringBoot-Music-Archive)**: Spring Boot 및 Open API 연동 기반 실시간 음원 검색/추천 아카이브 서비스  
* **[Sim2Real-Drone-RL](https://github.com/wooeii/Sim2Real-Drone-RL)**: 강화학습 기반 드론 자율비행 제어 및 Sim2Real 시스템 구축  
